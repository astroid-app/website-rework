    ...
    <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
      <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8 animate-fade">
        ...
        <div class="mt-5 flex items-center gap-x-5">
          <a href="https://api.astroid.cc/discord" target="_blank" class=" flex-1 text-center rounded-md bg-blue-900 px-3.5 py-2.5 text-sm font-semibold text-blue-300 shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400"><i class="fa-brands fa-discord"></i> Join Discord</a>
          <a href="https://ko-fi.com/astroidapp" target="_blank" class=" flex-1 text-center rounded-md bg-blue-900 px-3.5 py-2.5 text-sm font-semibold text-blue-300 shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400"><i class="fa-solid fa-circle-dollar-to-slot"></i> Support Us</a>
        </div>
      </div>
      <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32 animate-fade-left">
        <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
            <img id="randomImage" src="/src/assets/img/d2.png" alt="App screenshot" width="2432" height="1442" class="w-[76rem] rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10">
          <script>
            document.addEventListener('DOMContentLoaded', function() {
            const images = ['d1.png', 'd2.png'];
            const randomImage = images[Math.floor(Math.random() * images.length)];
            document.getElementById('randomImage').src = `/src/assets/img/${randomImage}`;
            });
          </script>
        </div>
      </div>
  ...
  <div class="relative isolate overflow-hidden bg-gray-900">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
      <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8 animate-fade">
        ...
        <h1 class="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl animate-fade animate-delay-250">A Bridge Between All Platforms</h1>
        <div class="mt-6 relative overflow-hidden rounded-2xl border border-cyan-300/30 bg-slate-900/60 p-5 shadow-2xl shadow-cyan-900/30 ring-1 ring-white/10 backdrop-blur-md">
          <div class="pointer-events-none absolute -right-10 -top-10 h-32 w-32 rounded-full bg-cyan-400/20 blur-2xl" aria-hidden="true"></div>
          <div class="pointer-events-none absolute -bottom-10 -left-10 h-32 w-32 rounded-full bg-blue-500/20 blur-2xl" aria-hidden="true"></div>
          <div class="relative">
            <span class="inline-flex items-center gap-2 rounded-full border border-cyan-300/30 bg-cyan-400/10 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-cyan-200">
              <i class="fa-solid fa-sparkles"></i> We are hiring volunteers
            </span>
            <p class="mt-3 text-lg font-semibold text-white">Join the Astroid dev team</p>
            <p class="mt-1 text-sm text-blue-100/90">If you want to build cool cross-platform tools with us, we would love to meet you.</p>
            <div class="mt-4 grid grid-cols-1 gap-2 text-sm sm:grid-cols-3">
              <div class="rounded-xl bg-slate-950/50 px-3 py-2 text-cyan-100 ring-1 ring-cyan-300/20"><i class="fa-solid fa-user-check"></i> 18+ only</div>
              <div class="rounded-xl bg-slate-950/50 px-3 py-2 text-cyan-100 ring-1 ring-cyan-300/20"><i class="fa-solid fa-handshake"></i> Hobby project (no payment)</div>
              <div class="rounded-xl bg-slate-950/50 px-3 py-2 text-cyan-100 ring-1 ring-cyan-300/20"><i class="fa-solid fa-code"></i> TypeScript and/or Python</div>
            </div>
            <div class="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <p class="text-sm text-cyan-100"><i class="fa-solid fa-ticket"></i> To apply, open a ticket on our Discord server.</p>
              <a href="https://api.astroid.cc/discord" target="_blank" class="inline-flex items-center justify-center gap-2 rounded-lg bg-cyan-500/20 px-4 py-2 text-sm font-semibold text-cyan-100 ring-1 ring-cyan-300/30 hover:bg-cyan-500/30 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300">
                <i class="fa-brands fa-discord"></i> Open Ticket on Discord
              </a>
            </div>
          </div>
  ...
  <div class="relative isolate overflow-hidden bg-gray-900">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
      <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8 animate-fade">
        ...
        <h1 class="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl animate-fade animate-delay-250">A Bridge Between All Platforms</h1>
        <div class="mt-6 overflow-hidden rounded-2xl border border-cyan-400/30 bg-gradient-to-r from-cyan-500/15 via-blue-500/10 to-indigo-500/15 p-5 shadow-lg shadow-cyan-900/20 ring-1 ring-white/10">
          <p class="text-base font-semibold text-white"><i class="fa-solid fa-heart"></i> Join our volunteer dev team</p>
          <p class="mt-1 text-sm text-blue-100/90">Want to help us build Astroid? We are looking for friendly developers who enjoy community projects.</p>
          <div class="mt-4 grid grid-cols-1 gap-2 text-sm sm:grid-cols-3">
            <div class="rounded-lg bg-slate-900/60 px-3 py-2 text-cyan-100 ring-1 ring-cyan-300/20"><i class="fa-solid fa-user-check"></i> 18+ only</div>
            <div class="rounded-lg bg-slate-900/60 px-3 py-2 text-cyan-100 ring-1 ring-cyan-300/20"><i class="fa-solid fa-handshake"></i> Hobby project (no payment)</div>
            <div class="rounded-lg bg-slate-900/60 px-3 py-2 text-cyan-100 ring-1 ring-cyan-300/20"><i class="fa-solid fa-code"></i> TypeScript and/or Python</div>
          </div>
        </div>
        <p class="mt-6 text-lg leading-8 text-gray-300 animate-fade animate-delay-500">Astroid enables seamless integration of Discord, Guilded, Nerimity, and Revolt servers. Messaging across platforms, fostering streamlined communication on community growth. Expand your reach and engage with a broader audience, accelerating online community development.</p>
        <div class="mt-10 flex items-center gap-x-5">
  ...
  <div class="relative isolate overflow-hidden bg-gray-900">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
      <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8 animate-fade">
        ...
        <h1 class="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl animate-fade animate-delay-250">A Bridge Between All Platforms</h1>
        <div class="mt-6 rounded-lg border border-blue-500/30 bg-blue-500/10 p-4 text-sm text-blue-100">
          <p class="font-semibold"><i class="fa-solid fa-code"></i> We are searching for developers</p>
          <ul class="mt-2 list-disc pl-5 space-y-1 text-blue-200">
            <li>18+</li>
            <li>It is a hobby project, so no payment</li>
            <li>TypeScript and/or Python</li>
          </ul>
        </div>
        <p class="mt-6 text-lg leading-8 text-gray-300 animate-fade animate-delay-500">Astroid enables seamless integration of Discord, Guilded, Nerimity, and Revolt servers. Messaging across platforms, fostering streamlined communication on community growth. Expand your reach and engage with a broader audience, accelerating online community development.</p>
        <div class="mt-10 flex items-center gap-x-5">
