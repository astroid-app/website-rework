    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3">
        ...
        <div class="p-6 bg-gray-800 dark:bg-gray-700 rounded-lg shadow-lg">
          ...
          <a href="https://github.com/isanosaurus" class="mt-4 text-base text-purple-500 hover:text-purple-400">View GitHub profile</a>
        </div>
        ...
        <div class="flex items-center justify-center h-24 w-24 rounded-full bg-purple-600">
          ...
          <a href="https://github.com/catpawzz" class="mt-4 text-base text-purple-500 hover:text-purple-400">View GitHub profile</a>
        </div>
