...
<head>
    ...
    <meta name="author" content="💖 Astroid | About">
      ...
      <div class="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3">
        <div class="p-6 bg-gray-800 dark:bg-gray-700 rounded-lg shadow-lg">
          <div class="flex items-center justify-center h-24 w-24 rounded-full bg-purple-600">
            <img src="/src/assets/img/french-femboi.gif" class="h-24 w-24 p-0 rounded-full">
          </div>
        ...
        <div class="p-6 bg-gray-800 dark:bg-gray-700 rounded-lg shadow-lg">
          <div class="flex items-center justify-center h-24 w-24 rounded-full bg-purple-600">
            <img src="/src/assets/img/elpoep.png" class="h-24 w-24 p-0 rounded-full">
          </div>
          <h3 class="mt-4 text-lg font-medium text-white dark:text-gray-900">Yuray</h3>
          <p class="mt-2 text-base text-gray-300 dark:text-gray-500">Web developer</p>
