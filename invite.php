...
<head>
    ...
    <meta name="author" content="💖 Astroid | Invite">
...
<body class="bg-gray-900">
    ...
    <div class="relative isolate overflow-hidden bg-gray-900">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40 animate-fade">
            <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                <h1 class="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">Invites</h1>
                <p class="mt-6 text-lg leading-8 text-gray-300">Start now by inviting our bots</p>
    ...
    <div class="container mx-auto px-6 py-10 text-white">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-5">
            ...
            <p class="text-gray-300 mt-4">Control every aspect of your bridge with the Astroid Discord Bot and start growth outside of Discord.</p>
            <a href="https://api.astroid.cc/invite/discord" target="_blank" class="mt-4 inline-flex items-center gap-x-2 bg-blue-900 text-blue-300 px-4 py-2 rounded-md shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400">Invite the Astroid Discord Bot <i class="fa-solid fa-external-link"></i></a>
            </div>
            <div class="card bg-gray-800 p-6 rounded-lg shadow-md">
            <h2 class="text-2xl font-bold text-white">Guilded</h2>
            <p class="text-gray-300 mt-4">Connect your Guilded Server with Astroid to grow your community.</p>
            ...
            <a href="https://api.astroid.cc/discord" target="_blank" class="mt-4 inline-flex items-center gap-x-2 bg-blue-900 text-blue-300 px-4 py-2 rounded-md shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400">Invite the Astroid Guilded Bot <i class="fa-solid fa-external-link"></i></a>
            </div>
            <div class="card bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <p class="text-gray-300 mt-4">The closed beta is now open for everyone. Apply to get access to early access features and updates.</p>
            <a href="https://api.astroid.cc/discord" target="_blank" class="mt-4 inline-flex items-center gap-x-2 bg-blue-900 text-blue-300 px-4 py-2 rounded-md shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400">Invite the Astroid Guilded Bot <i class="fa-solid fa-external-link"></i></a>
            </div>
        </div>
